...
- 保存成功後にのみ画面上の状態を更新
- 旧保存形式およびschema v1／v2からschema v3へのMigration
...
テストでは、状態更新と保存失敗時の整合性、Legacy migration、Person／Topic／PersonTopicの操作、画面遷移、複数話題の一括割り当て、検索・Filter、狭幅表示などを確認しています。
